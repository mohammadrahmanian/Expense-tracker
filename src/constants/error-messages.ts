...
export const ERROR_MESSAGES = {
  // Network errors
  NETWORK: {
    NO_RESPONSE: 'Unable to connect to the server. Please check your internet connection.',
  ...
  DASHBOARD: {
    ...
    CATEGORY_EXPENSES_FAILED: 'Failed to load expense breakdown. Please try again.',
